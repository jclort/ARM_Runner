...
*/
public class CarrySetTest extends ConditionTestSetup {

	@Test
	void testWithNegCmpResult() {
		setReg0And1ValsAndExecuteCompare(1, 2);
		assertFalse(new CarrySet().isTrue(sInst));
	}
	
	@Test
	void testWithZeroCmpResult() {
		setReg0And1ValsAndExecuteCompare(1, 1);
		assertTrue(new CarrySet().isTrue(sInst));
	}
	...
	public void testCode() throws Exception {
		assertEquals("CS", new CarrySet().code());
	}
}
