...
public class Divide extends ArithmeticInstruction {

	Divide(int destination, int source1, DataSource source2)
	{
	...
	public static Divide create(Object[] args) {
		if(args == null) {
			return null;
		}
		return new Divide((Integer)args[0], (Integer)args[1], (DataSource)args[2]);
	}
